  ...
  return (
    <main className="flex-1 max-w-5xl mx-auto px-4 py-12 w-full">
      ...
      <p className="text-gray-400 mb-8">
        ...
        {' '}·{' '}
        <span className="text-[#ff9f1c] font-semibold">{roleLabel}</span>
      </p>
      ...
      {session.role === 'admin' && (
        <div className="rounded border border-white/10 bg-white/5 px-6 py-5">
          ...
          <a
            href="/admin"
            className="inline-block bg-[#ff9f1c] text-white px-4 py-2 rounded font-bold text-xs uppercase tracking-widest hover:bg-red-700"
          >
            Open Admin Panel
          </a>
        </div>
