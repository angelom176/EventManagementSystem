  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-4">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full rounded bg-[#ff9f1c] py-2 text-sm font-bold text-white hover:bg-[#ffbf69] transition-colors"
        >
          Register
        </button>
        ...
        <p className="text-center text-sm text-gray-500">
          ...
          <a href="/login" className="text-[#ff9f1c] hover:underline">
            Log in
          </a>
        </p>
      </form>
